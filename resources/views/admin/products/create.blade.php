                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <textarea name="efficacy_milestones[0]" rows="2"
                               ...
                               placeholder="예: 초기 톤&#10;개선 체감"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">{{ old('efficacy_milestones.0', '') }}</textarea>
                    </div>
                    <div>
                        ...
                        <textarea name="efficacy_milestones[1]" rows="2"
                               ...
                               placeholder="예: 색소 완화&#10;안정화"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">{{ old('efficacy_milestones.1', '') }}</textarea>
                    </div>
                </div>
            </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <textarea name="milestone_center_texts[0]" rows="2"
                               ...
                               placeholder="예: 피부 수분&#10;흡수 시작"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500">{{ old('milestone_center_texts.0', '') }}</textarea>
                    </div>
                    <div>
                        ...
                        <textarea name="milestone_center_texts[1]" rows="2"
                               ...
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500">{{ old('milestone_center_texts.1', '') }}</textarea>
                    </div>
                </div>
            </div>
