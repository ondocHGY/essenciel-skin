...
class Settings(BaseSettings):
    ...
    # 쿠키 keep-alive URL 목록 (Playwright로 순회 접속하여 세션 유지)
    # 무신사는 SSO API 로그인이라 keep-alive 불필요
    # 여러 도메인/페이지를 순회해야 모든 쿠키가 갱신됨
    KEEP_ALIVE_URLS: dict = {
        'qoo10': [
            'https://qsm.qoo10.jp/GMKT.INC.Gsm.Web/Default.aspx',
        ],
        'naver': [
        ...
        'shopee': [
            'https://seller.shopee.kr/',
            'https://seller.shopee.kr/portal/settings/shop/rating',
        ],
    }
